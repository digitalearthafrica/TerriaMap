...
TerriaMap will be folded into TerriaJS to streamline development, changes will continue to be mirrored out to TerriaMap - consider migrating your fork to `terriajs/terriajs` if you are actively maintaining two separate forks (TerriaMap+terriajs).
